return {
  -- lspconfig
  {
    ...
    opts = function()
      ...
      local ret = {
        ...
        diagnostics = {
          ...
          signs = {
            text = {
              [vim.diagnostic.severity.ERROR] = utils.config.icons.diagnostics.Error,
              [vim.diagnostic.severity.WARN] = utils.config.icons.diagnostics.Warn,
              [vim.diagnostic.severity.HINT] = utils.config.icons.diagnostics.Hint,
              [vim.diagnostic.severity.INFO] = utils.config.icons.diagnostics.Info,
            },
          },
        },
    ...
    config = function(_, opts)
      ...
      utils.lsp.setup()
      -- utils.lsp.on_dynamic_capability(require('lazyvim.plugins.lsp.keymaps').on_attach)
